...
export default function PlayinGroup_Article({teams}) {
  ...
  return (
    <StyledLink to={'/championship/'+ teams.name[0] }>
        <p style={{position:'absolute', height:'50%',left:'1%' ,fontSize:'50px', fontWeight:'', color:'white'}}>{teams.playin[2]}</p>
        ...
        <div style={{position:'absolute', left:'35%'}}>
            ...
            <p style={{margin:'0', color:'rgba(255,255,255,0.6)', fontFamily:'ColfaxB'}}>{teams.playin[1]}</p>
        </div>
    </StyledLink>
  )
}
