...
export default function Group({style}) {
  ...
  let contentC = [];
  contentC.push(<div style={{height:'50px' ,borderBottom : '1px rgba(255,255,255,0.3) solid', color:'white', fontSize:'25px', marginTop:'10px'}}>C조</div>)
  let contentD = [];
  contentD.push(<div style={{height:'50px' ,borderBottom : '1px rgba(255,255,255,0.3) solid', color:'white', fontSize:'25px', marginTop:'10px'}}>D조</div>)
  ...
  return (
    <>
      <h1 style={{width:'100%', textAlign:'center', fontFamily:'RIXGOL', color:'white',}}>그룹 스테이지</h1>
      <div style={style}>
